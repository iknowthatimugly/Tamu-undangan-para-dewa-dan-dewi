...
<html lang="en">
  ...
  <div class="form-group ">
    <label for="exampleFormControlSelect1">Status Kesehatan/Penanganan</label>
    <select class="form-control" name="agama"  id="exampleFormControlSelect1" disabled>
       <?php if ($data['agama']=="Operasi") {?>
          <option >Operasi</option>
        <?php }elseif ($data['agama']=="Rawat Inap") {?>
          <option>Rawat Inap</option>
        <?php }elseif ($data['agama']=="Penanganan Darurat") {?>
          <option>Penanganan Darurat</option>
        <?php }elseif ($data['agama']=="Meninggal") {?>
