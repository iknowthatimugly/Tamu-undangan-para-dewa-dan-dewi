    ...
    <div class="container mt-5 mb-5 bg-light" style="Margin-top: 50px;">
      <form action="proses.php?aksi=update" method="post">
        ...
        <div class="form-group">
          ...
          <option <?php
                  if ($data['agama']=="Operasi") {?>
                  selected
                  <?php }?>>Operasi</option>
            <option <?php
                  if ($data['agama']=="Rawat Inap") {?>
                  selected
                  <?php }?>>Rawat Inap</option>
            <option <?php
                  if ($data['agama']=="Penanganan Darurat") {   ?>
                  selected
                  <?php }?>>Penanganan Darurat</option>
            <option <?php
                  if ($data['agama']=="Meninggal") {
                  ?>
                  selected
                  <?php }?>>Meninggal</option>
          </select>
        </div>
        <?php }?>
