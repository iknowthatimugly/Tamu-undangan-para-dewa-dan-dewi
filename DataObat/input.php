...
<div class="container mt-5 mb-5 bg-light" style="Margin-top: 50px;">
  ...
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Dosis Penggunaan obat</label>
  ...
  <div class="form-group">
    <label for="exampleFormControlInput3">Jenis Obat</label><br>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="jenis_kelamin" id="inlineRadio1" value="Herbal" checked>
            <label class="form-check-label" for="inlineRadio1" >Herbal</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="jenis_kelamin" id="inlineRadio2" value="Non herbal">
