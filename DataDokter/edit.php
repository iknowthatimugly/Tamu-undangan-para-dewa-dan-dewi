  ...
  <body class="bg-dark">
    ...
    <div class="container mt-5 mb-5 bg-light" style="Margin-top: 50px;">
      <form action="proses.php?aksi=update" method="post">
        ...
        <div class="form-group">
          <label for="exampleFormControlTextarea1">Catatan dokter</label>
        ...
        <div class="form-group">
          <label for="exampleFormControlSelect1">Bidang keahlian kedokteran</label>
          <select class="form-control" name="agama" id="exampleFormControlSelect1">
          <option <?php
                  if ($data['agama']=="Specialis Bedah") {?>
                  selected
                  <?php }?>>Specialis Bedah</option>
            <option <?php
                  if ($data['agama']=="Specialis Kanker") {?>
                  selected
                  <?php }?>>Specialis Kanker</option>
            <option <?php
                  if ($data['agama']=="Specialis anak & bayi") {   ?>
                  selected
                  <?php }?>>Specialis anak & bayi</option>
            <option <?php
                  if ($data['agama']=="Dokter umum") {
                  ?>
                  selected
                  <?php }?>>Dokter umum</option>
          </select>
        </div>
        <?php }?>
