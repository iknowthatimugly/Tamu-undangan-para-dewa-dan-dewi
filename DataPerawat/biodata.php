...
<html lang="en">
  ...
  <div class="form-group">
    <label for="exampleFormControlTextarea1">Bidang Keahlian</label></label>
  ...
  <div class="form-group ">
    <label for="exampleFormControlSelect1">Keahlian Perawatan</label>
    <select class="form-control" name="agama"  id="exampleFormControlSelect1" disabled>
       <?php if ($data['agama']=="Pembantu Operasi") {?>
          <option >Pembantu Operasi</option>
        <?php }elseif ($data['agama']=="Perawat pasien inap") {?>
          <option>Perawat pasien inap</option>
        <?php }elseif ($data['agama']=="Perawat anak dan bayi") {?>
          <option>Perawat anak dan bayi</option>
        <?php }elseif ($data['agama']=="Perawat Jenazah") {?>
          <option>Perawat Jenazah</option>
        <?php }?>
    </select>
  </div>
